using DesafioFinal.Exceptions;
using DesafioFinal.InputModel;
using DesafioFinal.Services;
using DesafioFinal.ViewModel;
...
namespace DesafioFinal.Controllers.v1
{
    ...
    public class JogoController : ControllerBase
    {
        ...
        /// <summary>
        /// Buscar todos os jogos de forma paginada com pagina e quantidade 
        /// </summary>
        /// <remarks>
        ...
        /// <response code="206">Retorna a lista de jogos</response>
